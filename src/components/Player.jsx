...
const Player = () => {
  ...
  const {seekBar,seekBg,playStatus,play,pause,track,time,previous,next,seekSong,errorHandler} = useContext(PlayerContext)
  ...
  return (
    <div className='h-[10%] bg-black flex justify-between items-center px-4 text-white'>
        ...
        <div onClick={errorHandler} className="hidden lg:flex gap-2 items-center opacity-75 cursor-pointer">
